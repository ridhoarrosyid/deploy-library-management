          ...
          {['loan', 'return_book'].map((key, index) => {
            return (
              <button
                ...
                className="relative z-30 flex flex-1 flex-col justify-center gap-1 border-t px-6 py-4 text-left even:border-2 data-[active=true]:bg-muted/50 sm:border-t-0 sm:px-8 sm:py-6"
                onClick={() => {
                  setActiveChart(key);
                }}
              >
