          ...
          <div className="flex flex-col items-center justify-center py-12 lg:py-48">
            <div className="mx-auto flex w-full flex-col gap-6 lg:w-1/2">
              <div className="grid gap-2 text-center">
                ...
                <p className="text-balance text-muted-foreground">Gunakan password yang aman dan mudah Anda ingat</p>
              </div>
              {/* form */}
              <form onSubmit={onHandleSubmit}>
                <div className="grid gap-4">
                  ...
                  <Button type="submit" variant="orange" className="w-full" size="xl" disabled={processing}>
                    Reset Password
                  </Button>
                </div>
              </form>
