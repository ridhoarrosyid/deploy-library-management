...
export default function Create(props) {
  const { data, setData, reset, post, processing, errors } = useForm({
    late_fee_per_day: props.fine_setting?.late_fee_per_day ?? '',
    damage_fee_percentage: props.fine_setting?.damage_fee_percentage ?? '',
    lost_fee_percentage: props.fine_setting?.lost_fee_percentage ?? '',
        ...
        <CardContent className="p-6">
          <form onSubmit={onHandleSubmit} className="space-y-6">
            <div className="grid w-full items-center gap-1.5">
              <Label htmlFor="late_fee_per_day">Denda Keterlambatan (Rp)</Label>
              <Input
