import IconChecklish from '@/Components/icons/IconChecklish';
...
export default function Approve({ conditions, action }) {
  const { data, put, errors, setData, processing } = useForm({
    condition: null,
    notes: '',
    _method: 'PUT',
  });
    ...
    <Sheet>
      <SheetTrigger asChild>
        <Button variant="green" size="sm">
          <IconChecklish className={'size-4 text-white'} />
        </Button>
      </SheetTrigger>
      <SheetContent>
        <SheetHeader>
          <SheetTitle>Konfirmasi Kondisi Buku</SheetTitle>
          <SheetDescription>Perikas kondisi buku sesuai buku yang dikembalikan oleh member</SheetDescription>
        </SheetHeader>
