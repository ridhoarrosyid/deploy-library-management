...
export default function Edit(props) {
  ...
  const { data, setData, reset, post, processing, errors } = useForm({
    ...
    publication_year: props.book.publication_year.toString() ?? null,
    ...
    category_id: props.book.category_id.toString() ?? null,
    publisher_id: props.book.publisher_id.toString() ?? null,
