  ...
  return (
    <div className="flex w-full flex-col space-y-4 pb-32">
      <div className="flex flex-col items-start justify-between gap-y-4 lg:flex-row lg:items-center">
        <HeaderTitle title={props.page_settings.title} subtitle={props.page_settings.subtitle} icon={IconChartDots2} />
      </div>
        ...
        <Card className="w-full lg:w-1/2">
          ...
          <CardContent className="px-0 py-0 [&_td]:whitespace-nowrap [&_td]:px-6 [&_th]:px-6">
            <Table className="w-full">
              ...
              <TableBody>
                {props.page_data?.most_loan_books.map((most_loan_book, i) => (
                  <TableRow key={i}>
        ...
        <Card className="w-full lg:w-1/2">
          ...
          <CardContent className="px-0 py-0 [&_td]:whitespace-nowrap [&_td]:px-6 [&_th]:px-6">
            <Table className="w-full">
              ...
              <TableBody>
                {props.page_data?.least_loan_books.map((least_loan_book, i) => (
                  <TableRow key={i}>
                    <TableCell> {i + 1} </TableCell>
